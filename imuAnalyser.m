function [transVecImu, angVecImu, transV] = imuAnalyser(imuTime, imuACC, imuGYR, t0, t1, nearest_index0, nearest_index1, transV)
...
for j=nearest_index0:nearest_index1
    ...
    transV = transV+imuACC(j, :)'*(t_imu1-t_imu0);
    transVecImu = transVecImu+transV*(t_imu1-t_imu0);
